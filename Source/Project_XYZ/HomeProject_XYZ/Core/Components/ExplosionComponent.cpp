...
void UExplosionComponent::Explode(AController* Controller)
{
	...
	UGameplayStatics::ApplyRadialDamageWithFalloff(GetWorld(), MaxDamage, MinDamage, GetComponentLocation(), InnerRadius, 
		OuterRadius, DamageFalloff, DamageTypeClass, IgnoreActors, GetOwner(), Controller, ECC_Visibility);
