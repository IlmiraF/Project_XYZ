...
void AMeleeWeaponItem::BeginPlay()
{
	...
	for (UMeleeHitRegistrator* HitRegistrator : HitRegistrators)
	{
		HitRegistrator->OnMeleeHitRegistred.AddUFunction(this, FName("ProccessHit"));
	}
}
...
void AMeleeWeaponItem::ProccessHit(const FHitResult& HitResult, const FVector& HitDirection)
{
